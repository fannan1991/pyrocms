...
/* D:\phpstudy\WWW\pyrocms\storage\streams/default//support/parsed/1b0fbbfee09935bf64d5ac28ae4d1c10.twig */
class __TwigTemplate_454f8f1ade2605bc87fc4f8fae145bb5b5e800f4982a704b42576155c5c326b8 extends TwigBridge\Twig\Template
{
  ...
  src: url('";
        // line 3
        echo call_user_func_array($this->env->getFunction('asset_path')->getCallable(), array("path", "theme::fonts/glyphicons/glyphicons-regular.eot"));
        echo "');
  src: url('";
        // line 4
        echo call_user_func_array($this->env->getFunction('asset_path')->getCallable(), array("path", "theme::fonts/glyphicons/glyphicons-regular.eot"));
        echo "?#iefix') format('embedded-opentype'), url('";
        echo call_user_func_array($this->env->getFunction('asset_path')->getCallable(), array("path", "theme::fonts/glyphicons/glyphicons-regular.woff2"));
        echo "') format('woff2'), url('";
        echo call_user_func_array($this->env->getFunction('asset_path')->getCallable(), array("path", "theme::fonts/glyphicons/glyphicons-regular.woff"));
        echo "') format('woff'), url('";
        echo call_user_func_array($this->env->getFunction('asset_path')->getCallable(), array("path", "theme::fonts/glyphicons/glyphicons-regular.ttf"));
        echo "') format('truetype'), url('";
        echo call_user_func_array($this->env->getFunction('asset_path')->getCallable(), array("path", "theme::fonts/glyphicons/glyphicons-regular.svg"));
...
@font-face {
  ...
  src: url('";
        // line 8
        echo call_user_func_array($this->env->getFunction('asset_path')->getCallable(), array("path", "theme::fonts/glyphicons/glyphicons-filetypes-regular.eot"));
        echo "');
  src: url('";
        // line 9
        echo call_user_func_array($this->env->getFunction('asset_path')->getCallable(), array("path", "theme::fonts/glyphicons/glyphicons-filetypes-regular.eot"));
        echo "?#iefix') format('embedded-opentype'), url('";
        echo call_user_func_array($this->env->getFunction('asset_path')->getCallable(), array("path", "theme::fonts/glyphicons/glyphicons-filetypes-regular.woff2"));
        echo "') format('woff2'), url('";
        echo call_user_func_array($this->env->getFunction('asset_path')->getCallable(), array("path", "theme::fonts/glyphicons/glyphicons-filetypes-regular.woff"));
        echo "') format('woff'), url('";
        echo call_user_func_array($this->env->getFunction('asset_path')->getCallable(), array("path", "theme::fonts/glyphicons/glyphicons-filetypes-regular.ttf"));
        echo "') format('truetype'), url('";
        echo call_user_func_array($this->env->getFunction('asset_path')->getCallable(), array("path", "theme::fonts/glyphicons/glyphicons-filetypes-regular.svg"));
...
@font-face {
  ...
  src: local('Montserrat-Regular'), url('";
        // line 2689
        echo call_user_func_array($this->env->getFunction('asset_path')->getCallable(), array("path", "theme::fonts/montserrat/montserrat-regular.woff2"));
        echo "') format('woff2'), url('";
        echo call_user_func_array($this->env->getFunction('asset_path')->getCallable(), array("path", "theme::fonts/montserrat/montserrat-regular.woff"));
        echo "') format('woff');
...
@font-face {
  ...
  src: local('Montserrat-Bold'), url('";
        // line 2696
        echo call_user_func_array($this->env->getFunction('asset_path')->getCallable(), array("path", "theme::fonts/montserrat/montserrat-bold.woff2"));
        echo "') format('woff2'), url('";
        echo call_user_func_array($this->env->getFunction('asset_path')->getCallable(), array("path", "theme::fonts/montserrat/montserrat-bold.woff"));
        echo "') format('woff');
  unicode-range: U0-0FF, U131, U152-153, U2C 6, U2DA, U2DC, U2000-206F, U2074, U20AC, U2212, U2215, UE0FF, UEFFD, UF000; }
/*!
...
@font-face {
  ...
  src: url('";
        // line 2706
        echo call_user_func_array($this->env->getFunction('asset_path')->getCallable(), array("path", "theme::fonts/font-awesome/fontawesome-webfont.eot"));
        echo "');
  src: url('";
        // line 2707
        echo call_user_func_array($this->env->getFunction('asset_path')->getCallable(), array("path", "theme::fonts/font-awesome/fontawesome-webfont.eot"));
        echo "?#iefix') format('embedded-opentype'), url('";
        echo call_user_func_array($this->env->getFunction('asset_path')->getCallable(), array("path", "theme::fonts/font-awesome/fontawesome-webfont.woff2"));
        echo "') format('woff2'), url('";
        echo call_user_func_array($this->env->getFunction('asset_path')->getCallable(), array("path", "theme::fonts/font-awesome/fontawesome-webfont.woff"));
        echo "') format('woff'), url('";
        echo call_user_func_array($this->env->getFunction('asset_path')->getCallable(), array("path", "theme::fonts/font-awesome/fontawesome-webfont.ttf"));
        echo "') format('truetype'), url('";
        echo call_user_func_array($this->env->getFunction('asset_path')->getCallable(), array("path", "theme::fonts/font-awesome/fontawesome-webfont.svg"));
...
.col-xs, .col-xs-1, .col-xs-2, .col-xs-3, .col-xs-4, .col-xs-5, .col-xs-6, .col-xs-7, .col-xs-8, .col-xs-9, .col-xs-10, .col-xs-11, .col-xs-12, .col-xs-13, .col-xs-14, .col-xs-15, .col-xs-16, .col-xs-17, .col-xs-18, .col-xs-19, .col-xs-20, .col-xs-21, .col-xs-22, .col-xs-23, .col-xs-24, .col-sm, .col-sm-1, .col-sm-2, .col-sm-3, .col-sm-4, .col-sm-5, .col-sm-6, .col-sm-7, .col-sm-8, .col-sm-9, .col-sm-10, .col-sm-11, .col-sm-12, .col-sm-13, .col-sm-14, .col-sm-15, .col-sm-16, .col-sm-17, .col-sm-18, .col-sm-19, .col-sm-20, .col-sm-21, .col-sm-22, .col-sm-23, .col-sm-24, .col-md, .col-md-1, .col-md-2, .col-md-3, .col-md-4, .col-md-5, .col-md-6, .col-md-7, .col-md-8, .col-md-9, .col-md-10, .col-md-11, .col-md-12, .col-md-13, .col-md-14, .col-md-15, .col-md-16, .col-md-17, .col-md-18, .col-md-19, .col-md-20, .col-md-21, .col-md-22, .col-md-23, .col-md-24, .col-lg, .col-lg-1, .col-lg-2, .col-lg-3, .col-lg-4, .col-lg-5, .col-lg-6, .col-lg-7, .col-lg-8, .col-lg-9, .col-lg-10, .col-lg-11, .col-lg-12, .col-lg-13, .col-lg-14, .col-lg-15, .col-lg-16, .col-lg-17, .col-lg-18, .col-lg-19, .col-lg-20, .col-lg-21, .col-lg-22, .col-lg-23, .col-lg-24, .col-xl, .col-xl-1, .col-xl-2, .col-xl-3, .col-xl-4, .col-xl-5, .col-xl-6, .col-xl-7, .col-xl-8, .col-xl-9, .col-xl-10, .col-xl-11, .col-xl-12, .col-xl-13, .col-xl-14, .col-xl-15, .col-xl-16, .col-xl-17, .col-xl-18, .col-xl-19, .col-xl-20, .col-xl-21, .col-xl-22, .col-xl-23, .col-xl-24 {
  position: relative;
  min-height: 1px;
  width: 100%;
  padding-right: 15px;
...
.navbar-light .navbar-brand, .navbar-light .navbar-toggler {
  ...
  .navbar-light .navbar-toggler {
    background-image: url(\"data:image/svg+xml;charset=utf8,%3Csvg viewBox='0 0 32 32' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath stroke='rgba(0, 0, 0, .3)' stroke-width='2' stroke-linecap='round' stroke-miterlimit='10' d='M4 8h24M4 16h24M4 24h24'/%3E%3C/svg%3E\");
...
.navbar-dark .navbar-brand, .navbar-dark .navbar-toggler {
  ...
  .navbar-dark .navbar-brand:focus, .navbar-dark .navbar-toggler:focus, .navbar-dark .navbar-brand:hover, .navbar-dark .navbar-toggler:hover {
    color: rgba(255, 255, 255, 1); }
...
";
    ...
    {
        return "D:\\phpstudy\\WWW\\pyrocms\\storage\\streams/default//support/parsed/1b0fbbfee09935bf64d5ac28ae4d1c10.twig";
    }
    ...
    {
        return array (  2768 => 2707,  2764 => 2706,  2749 => 2696,  2737 => 2689,  46 => 9,  42 => 8,  27 => 4,  23 => 3,  19 => 1,);
    }
    ...
    {
        return new Twig_Source("@font-face {
  font-family: 'Glyphicons Regular';
